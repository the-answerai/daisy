...
describe("Utils test suite", () => {
  ...
  test("getCompletionModelBasedOnTokenSize", () => {
    expect(getCompletionModelBasedOnTokenSize(1000)).toBe("gpt-3.5-turbo-16k");
    expect(getCompletionModelBasedOnTokenSize(5000)).toBe("gpt-3.5-turbo-16k");
    expect(getCompletionModelBasedOnTokenSize(10000)).toBe("gpt-3.5-turbo-16k");
    expect(getCompletionModelBasedOnTokenSize(20000)).toBe(null);
  });
